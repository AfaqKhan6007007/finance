...
urlpatterns = [
    ...
    path('dunnings/', DunningList.as_view(), name='finance-dunnings'),
    path('dunnings/new/', DunningCreate.as_view(), name='finance-dunning-create'),
    path('dunnings/<int:pk>/edit/', DunningEdit.as_view(), name='finance-dunning-edit'),
    path('dunnings/<int:pk>/delete/', DunningDelete.as_view(), name='finance-dunning-delete'),

    path('dunning_types/', DunningTypeList.as_view(), name='finance-dunning-types'),
    path('dunnings_types/new/', DunningTypeCreate.as_view(), name='finance-dunning-type-create'),
    path('dunning_types/<int:pk>/edit/', DunningTypeEdit.as_view(), name='finance-dunning-type-edit'),
    path('dunning_types/<int:pk>/delete/', DunningTypeDelete.as_view(), name='finance-dunning-type-delete'),
